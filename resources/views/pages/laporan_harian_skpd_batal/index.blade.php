...
@section('title', 'SKPD Batal')

@section('content')
<div class="card shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">SKPD Batal</h6>
    </div>
    <div class="card-body">
...
<script type="text/javascript">
    tableDokumen = $('#laporan_harian_skpd_batalTable').DataTable({
        responsive: true,
        processing: true,
        serverSide: true,
        ajax: '{!! route('laporan_harian_skpd_batal.index') !!}',
        columns: [
