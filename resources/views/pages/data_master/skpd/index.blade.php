...
@section('title', 'Master Data SKPD')
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Master Data SKPD</h5>
            </div>
            <div class="card-body">
                <a class="btn btn-primary btn-sm" title="Tambah SKPD" data-bs-toggle="modal"
                    data-bs-target="#modalContainer" data-title="Tambah SKPD" href="{{ route('skpd.create') }}"><i
